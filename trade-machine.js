...
'.tm-a.on{background:rgba(255,255,255,.07);outline:1px solid var(--accent);}',
...
'.tm-pill{border:1px solid transparent;}',
'.tm-pill.p{background:rgba(255,255,255,.06);border-color:var(--ok);color:var(--ok);}',
'.tm-pill.n{background:rgba(255,255,255,.06);border-color:var(--danger);color:var(--danger);}',
...
'.tm-w.bad{border-left-color:var(--danger);} .tm-w.good{border-left-color:var(--ok);} .tm-w.warn{border-left-color:var(--conflict-line);}',
